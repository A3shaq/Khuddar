...
<ScrollView alwaysBounceVertical showsVerticalScrollIndicator={false} style={{marginBottom:RFValue(138)}}>
    ...
    <ServiceCard src={require('../../../../images/services/f16.png')} onPress={()=>{navigation.navigate(Nav.SelectedFood)}} title="Selected Furniture" />
    <ServiceCard src={require('../../../../images/services/f16.png')} onPress={()=>{navigation.navigate(Nav.ListFood)}} title="List Furniture" />
    </View>
    </View>
    </ScrollView>
