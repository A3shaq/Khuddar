...
<ScrollView alwaysBounceVertical showsVerticalScrollIndicator={false} >
    ...
    <ServiceCard src={require('../../../../images/services/f15.png')} onPress={()=>{navigation.navigate(Nav.SelectedFurniture)}} title="Furniture" />
    <ServiceCard src={require('../../../../images/services/f22.png')}  onPress={()=>{navigation.navigate(Nav.FurnitureList)}} title="List Funritures" />
    </View>
    </View>
    </ScrollView>
