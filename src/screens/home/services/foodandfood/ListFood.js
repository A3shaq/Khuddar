...
import { ScrollView, View, TouchableOpacity,Text, Alert, PushNotificationIOS } from 'react-native'
...
const ListFood = () => {
    ...
    const Food= async()=>{
        const response = await RNFetchBlob.fetch(
            'GET',
            `https://khuddar.org/application/api/services/food`,
            {
    ...
    <TopDrawer/>
        <ScrollView>
            ...
            <View style={[styles.ctr, styles.mt5]}>
                <Heading head="Food and Food" label="Select food" />
