...
<ScrollView alwaysBounceVertical showsVerticalScrollIndicator={false} style={{marginBottom:RFValue(138)}}>
    ...
    <ServiceCard src={require('../../../images/services/f14.png')} onPress={()=>{navigation.navigate(Nav.AddBarat)}} title="Baraat" />
    <ServiceCard src={require('../../../images/services/f15.png')} onPress={()=>{navigation.navigate(Nav.FunritureHome)}} title="Furniture" />
    </View>
    <View style={{display:'flex',flexDirection:'row',justifyContent:'space-evenly',alignItems:'center',marginTop:RFValue(15)}}>
    ...
    <View style={{display:'flex',flexDirection:'row',justifyContent:'space-evenly',alignItems:'center',marginTop:RFValue(15)}}>
    <ServiceCard src={require('../../../images/services/f20.png')} onPress={()=>{navigation.navigate(Nav.appliances)}} title="Appliances" />
